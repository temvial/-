...
// ========== АНИМАЦИЯ ДОБАВЛЕНИЯ ПРОЦЕССА (свой код) ==========
function animateNewProcess(element) {
...
function handleAddProcess(event) {
  ...
  // Вывоз анимации (свой код)
var lastRow = document.querySelector('#table-body tr:last-child');
if (lastRow) {
    animateNewProcess(lastRow);
}
